  ...
  const renderResWrap = (
    ...
    >
      ...
      {isCallBatchAPI && allFailedTaskList.length > 0 && (
        <div className="absolute z-10 flex items-center gap-2 p-3 -translate-x-1/2 border shadow-lg bottom-6 left-1/2 rounded-xl border-components-panel-border bg-components-panel-bg-blur backdrop-blur-sm">
          ...
          <div
            ...
            className="cursor-pointer system-sm-semibold-uppercase text-text-accent"
          >
    ...
    >
      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            />
            <div className="truncate system-md-semibold grow text-text-secondary">
              {siteInfo.title}
            </div>
      ...
      >
        {!isPC && (
          ...
          >
            <div className="w-8 h-1 rounded cursor-grab bg-divider-solid" />
          </div>
        )}
        {renderResWrap}
      </div>
